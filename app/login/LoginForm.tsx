      ...
      <div className="fade-in-up" style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '1rem', padding: '2rem' }}>
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.4rem' }}>
                ...
                <Link href="/forgot-password" style={{ fontSize: '0.75rem', color: 'var(--teal-secondary)', textDecoration: 'none' }}>
                  Forgot password?
                </Link>
              </div>
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  required style={{ ...inputBase, paddingRight: '2.75rem' }} placeholder="••••••••"
                />
                <button
          ...
          <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
            ...
            <Link href="/register" style={{ color: 'var(--teal-secondary)', textDecoration: 'none' }}>Sign up</Link>
          </p>
        </div>
      </div>
    </div>
